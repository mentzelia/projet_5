...
<section class="devis">
    ...
    <form id="quotation-form" method="post" action="index.php?action=sendQuotation">
        
        <h3>Type de projet</h3>
        <fieldset>
            <legend>Sélectionnez votre type de projet:*</legend>

            <input id="showcaseBasic" name="project_type" value="showcaseBasic" type="radio" required>
            <label for="showcaseBasic">Site vitrine</label>
            <br/>
            <input id="showcaseAppointment" name="project_type" value="showcaseAppointment" type="radio" required>
            <label for="showcaseAppointment">Site avec réservation de rendez-vous en ligne</label>
            <br/>
            <input id="ecommerce" name="project_type" type="radio" value="ecommerce" required>
        ...
        <fieldset>
            ...
            <input id="max5" name="max_page" value="max5" type="radio" required>
            <label for="max5">1 à 5 pages</label>
            <br/>
            <input id="max10" name="max_page" type="radio" value="max10" required>
             <label for="max10">6 à 10 pages</label>
            <br/>
            <input id="max15" name="max_page" type="radio" value="max15" required>
        ...
        <fieldset>
            ...
            <input id="acceptTerms" name="acceptTerms" value="acceptTerms" type="checkbox" required> <label for="acceptTerms">En soumettant ce formulaire, j'accepte que les informations saisies soient utilisées uniquement dans le cadre de ma demande et de la relation commerciale éthique et personnalisée qui peut en découler.</label>
            <p>(*) Obligatoire</p>
        </fieldset>
